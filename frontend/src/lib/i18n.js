export const i18n = {
  zh: {
   ...
   // SSH Operations
    ...
    autoStop: '自动停机', autoStopAfter: '运行时长后自动停止', hoursLater: '小时后自动停止',
    ...
    aiChatCompleteNotify: 'AI 对话已完成', aiChatFailedNotify: 'AI 对话执行失败',
  ...
  en: {
    ...
    autoStop: 'Auto Stop', autoStopAfter: 'Auto stop after duration', hoursLater: 'hours later auto stop',
    ...
    aiChatCompleteNotify: 'AI chat completed', aiChatFailedNotify: 'AI chat failed',
