export const i18n = {
  zh: {
    ...
    resourceSummary: '资源概览', accountBalance: '账户余额', queryBalance: '查询', clickToQueryBalance: '点击上方按钮查询账户余额', currentMonthBill: '当月账单', queryBill: '查询', clickToQueryBill: '点击上方按钮查询当月账单', billCostWarning: 'AWS Cost Explorer USE1-APIRequest 调用每次约 $0.01', systemHealth: '系统健康', versionCheck: '版本检查', checkUpdate: '检查', clickToCheckUpdate: '点击上方按钮检查版本更新',
   ...
   // SSH Operations
    ...
    // AI Chat
    aiChat: 'AI 对话',
    aiChatFreeChat: '自由对话', aiChatAgent: 'Agent 助手', aiChatDeploy: '部署助手', aiChatErrorAnalysis: '报错分析', aiChatGenTemplate: '生成模板', aiChatRecommend: '推荐场景', aiChatCostOpt: '成本优化',
  ...
  en: {
    ...
    // AI Chat
    aiChat: 'AI Chat',
    aiChatFreeChat: 'Free Chat', aiChatAgent: 'Agent', aiChatDeploy: 'Deploy Assistant', aiChatErrorAnalysis: 'Error Analysis', aiChatGenTemplate: 'Generate Template', aiChatRecommend: 'Recommend Scenario', aiChatCostOpt: 'Cost Optimization',
