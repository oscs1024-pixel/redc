export const i18n = {
  zh: {
   ...
   // SSH Operations
    ...
    taskPending: '待执行', taskCompleted: '已完成', taskFailed: '失败', taskCancelled: '已取消',
  ...
  en: {
    ...
    taskPending: 'Pending', taskCompleted: 'Completed', taskFailed: 'Failed', taskCancelled: 'Cancelled',
