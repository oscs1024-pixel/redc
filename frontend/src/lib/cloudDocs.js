export const cloudDocs = [
  { name: 'Aliyun', nameZh: '阿里云', url: 'https://help.aliyun.com/', color: 'orange' },
  { name: 'TencentCloud', nameZh: '腾讯云', url: 'https://cloud.tencent.com/document/product', color: 'blue' },
  { name: 'Volcengine', nameZh: '火山引擎', url: 'https://www.volcengine.com/docs', color: 'blue' },
  { name: 'HuaweiCloud', nameZh: '华为云', url: 'https://support.huaweicloud.com/', color: 'red' },
  { name: 'UCloud', nameZh: 'UCloud', url: 'https://docs.ucloud.cn/terraform/README', color: 'purple' },
