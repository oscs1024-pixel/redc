...
<Modal show={true} onclose={onClose} class="p-4">
  <div class="bg-white rounded-xl border border-gray-200 shadow-xl w-[calc(100vw-2rem)] max-w-4xl max-h-[85vh] overflow-hidden flex flex-col" onclick={(e) => e.stopPropagation()}>
